...
// /**
//  *  Send Message
//  * Pushes a new message in the chat (sender = logged-in user).
//  */
...
//     const newMessage = { sender: senderId, text, isRead: false, createdAt: new Date() };
...
// /**
//  *  Get Messages
//  * Fetches messages of a specific chat and marks unread ones as read for receiver.
//  */
...
//     // Identify receiver (other participant)
