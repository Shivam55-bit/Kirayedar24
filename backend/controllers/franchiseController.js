...
exports.getDashboardCounts = async (req, res) => {
  try {
    const [drivers, vehicles, videos, franchises] = await Promise.all([
      FranDriver.countDocuments(),
      FranVehicle.countDocuments(),
      FranVideo.countDocuments(),
      FranFranchise.countDocuments(),
    ]);
