...
import express from 'express';
import { addProperty, getNearbyProperties,deleteProperty, updateProperty, visitProperty,markPropertyAsSold,getSoldProperties,deleteSoldProperty, getMySoldProperties,getAllProperties } from '../controllers/addController.js';
import  upload  from '../middlewares/addUploads.js';
import { verifyToken  } from '../middlewares/authMiddleware.js';
